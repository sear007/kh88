...
<div class="card">
    ...
    <div class="card-body">
      <table id="deposit-table" class="table table-bordered table-striped table-sm">
        <thead>
        <tr>
          <th>Username</th>
          <th>Payment</th>
...
<script>
            ...
            columns: [
                ...
                {"data": "id",render:function(data,type,row){
                    ...
                    <div class="btn-group btn-block" id="td-${data}">
                        <form></form>
                        <button  onclick="approve(${data},'${row.payment}','${row.created_at}','${row.transaction}', ${row.outStandingCredit})" data-toggle="tooltip" title="Approve" class="btn btn-sm btn-default"><i class="fas fa-check text-success"></i></button>
    ...
    function approve(id,payment,created_at,transaction,outStandingCredit){
        Swal.fire({
